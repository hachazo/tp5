# permite definir familia de algoritmos (poder encapsularlos) y poder hacerlos intercambiables.
# permite que los algoritmos sean independiente de los elementos que los estan usando.
# La ventaja es que permite definir (en este caso varios metodos de pago) sin tener que modificar el codigo.
# solo agregando metodos.
